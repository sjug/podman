...
func pullCmd(c *cli.Context) error {
	...
	if strings.HasPrefix(image, dockerarchive.Transport.Name()+":") {
		...
		newImage, err := runtime.ImageRuntime().New(opentracing.ContextWithSpan(getContext(), origSpan), image, c.String("signature-policy"), c.String("authfile"), writer, &dockerRegistryOptions, image2.SigningOptions{}, true, forceSecure)
		if err != nil {
